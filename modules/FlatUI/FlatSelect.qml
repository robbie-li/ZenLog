...
FlatButton {
    ...
    FlatIconButton {
        ...
        text: flatConstants.fontAwesome.fa_arrow_down;

        height: 20;
        width: 20;
    }

    property color dropdownColor: flatConstants.clouds
    property color dropdownHighlightColor: "#DFE2E3"
    property color dropdownTextColor: flatConstants.asbestos
    ...
    property int dropdownHeight: dropDown.dropdownItemHeight * listView.count
                        ...
                        onClicked: {
                            if (dropDown.enableScrollView) {
                                if (listView.itemChecked) {
                                    ...
                                    listView.highlightColor = flatConstants.secondary
                                }
                            }
