...
Page {
    ...
    function reload() {
        currentUser = SqlModel.getCurrentUser()
        courseModel.courseDate = datepicker.currentDate
        courseModel.userID = currentUser.userId
        console.log("realod daily log page finished")
    }
    ...
    ListView {
        ...
        model: CourseModel{
            ...
            courseDate: datepicker.currentDate
        }
        clip: true
